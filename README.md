...
![Ping not working](figures/PingNW.png)
...
![Ping working](figures/PingW.png)
...
![Ping not working WAN](figures/PingNWWAN.png)
...
iptables -A FORWARD -d 192.168.100.0/24 -i eth0 -p icmp -m icmp --icmp-type 0 -j ACCEPT
```
---
